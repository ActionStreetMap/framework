namespace ActionStreetMap.Explorer
{
    internal static class Strings
    {
        ...
        public static string GabledRoofGenFailed = "Gabled roof generation algorithm is failed for {0}";
        public static string HippedRoofGenFailed = "Hipped roof generation algorithm is failed for {0}";
        public static string MansardRoofGenFailed = "Mansard roof generation algorithm is failed for {0}";
