...
namespace ActionStreetMap.Core.Utilities
{
    ...
    public static class GeoProjection
    {
        ...
        {
            var dLat = MathUtility.Deg2Rad((first.Latitude - second.Latitude));
            var dLon = MathUtility.Deg2Rad((first.Longitude - second.Longitude));

            var lat1 = MathUtility.Deg2Rad(first.Latitude);
            var lat2 = MathUtility.Deg2Rad(second.Latitude);
