...
{
    /// <summary> Represents road junction. </summary>
    public class RoadJunction
    {
        ...
        /// <summary> Gets junction center point. </summary>
        public MapPoint Center { get; private set; }

        /// <summary> Gets junction connections. </summary>
        public List<RoadElement> Connections { get; private set; }

        /// <summary> Gest or sets polygon points. </summary>
        public List<MapPoint> Polygon { get; internal set; }

        /// <summary> Gest or sets traffic lights. </summary>
        public List<TrafficLight> TrafficLights { get; internal set; }

        /// <summary> Creates the instance of <see cref="RoadJunction"/>. </summary>
