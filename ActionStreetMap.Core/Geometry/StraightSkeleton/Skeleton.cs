...
namespace ActionStreetMap.Core.Geometry.StraightSkeleton
{
    ...
    public class Skeleton
    {
        ...
        public static SkeletonResult Create(List<Vector2d> polygon)
        {
            return Create(polygon, null);
        }

        /// <summary> Creates straight skeleton for given polygon with holes. </summary>
        public static SkeletonResult Create(List<Vector2d> polygon, List<List<Vector2d>> holes)
        {
        ...
        private static SkeletonResult AddFacesToOutput(List<FaceQueue> faces)
        {
            ...
            return new SkeletonResult(edgeOutputs, distances);
        }
