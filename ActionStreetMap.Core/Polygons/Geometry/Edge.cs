// ----------------------------------------------------------------------- 
// <copyright file="Edge.cs" company=""> Triangle.NET code by Christian Woltering, http://triangle.codeplex.com/ </copyright>
// ----------------------------------------------------------------------- 
...
namespace ActionStreetMap.Core.Polygons.Geometry
{
    ...
    public class Edge : IEdge
    {
        ...
        /// <summary> Gets the segments boundary mark. </summary>
        public int Boundary
        {
            get;
            private set;
