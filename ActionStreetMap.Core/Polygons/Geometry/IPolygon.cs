...
{
    /// <summary> Polygon interface. </summary>
    public interface IPolygon
    {
        ...
        /// <summary> Gets a list of pointers defining the regions of the polygon. </summary>
        List<RegionPointer> Regions { get; }

        /// <summary> Gets or sets value indicating wether the vertices have marks or not. </summary>
        bool HasPointMarkers { get; set; }

        /// <summary> Gets or sets value indicating wether the segments have marks or not. </summary>
