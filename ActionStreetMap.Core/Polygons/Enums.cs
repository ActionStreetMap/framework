...
namespace ActionStreetMap.Core.Polygons
{
    ...
    /// <remarks>
    /// The result of a search indicates that the point falls in the interior of a triangle, on an
    /// edge, on a vertex, or outside the mesh.
    /// </remarks>
    ...
    /// <remarks>
    /// The result indicates that the vertex was inserted with complete success, was inserted but
    /// encroaches upon a subsegment, was not inserted because it lies on a segment, or was not
    /// inserted because another vertex occupies the same location.
    /// </remarks>
    ...
    /// <remarks>
    /// The result indicates that a segment connecting the two query points falls within the
    /// direction triangle, along the left edge of the direction triangle, or along the right edge
