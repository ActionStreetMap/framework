...
namespace ActionStreetMap.Core.Polygons.Topology
{
    ...
    /// <remarks>
    /// Includes a pointer to a subsegment and an orientation. The orientation denotes a side of the
    /// edge. Hence, there are two possible orientations. By convention, the edge is always directed
    /// so that the "side" denoted is the right side of the edge.
    /// </remarks>
    public struct Osub
    {
        ...
        /// <summary> Read a boundary marker. </summary>
        /// <remarks>
        /// Boundary markers are used to hold user-defined tags for setting boundary conditions in
        ...
        /// <summary> Set a boundary marker. </summary>
        public void SetMark(int value)
        {
            seg.boundary = value;
        }

        /// <summary> Copy a subsegment. </summary>
        ...
        #endregion Osub primitives (internal)
    }
}