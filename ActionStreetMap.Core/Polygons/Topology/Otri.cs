...
namespace ActionStreetMap.Core.Polygons.Topology
{
    ...
    /// <remarks>
    /// Includes a pointer to a triangle and orientation. The orientation denotes an edge of the
    /// triangle. Hence, there are three possible orientations. By convention, each edge always
    /// points counterclockwise about the corresponding triangle.
    /// </remarks>
    public struct Otri
    {
        ...
        #endregion Otri primitives (public)
        ...
        /// <remarks>
        /// Note that the other triangle will still think it's connected to this triangle. Usually,
        /// however, the other triangle is being deleted entirely, or bonded to another triangle, so
        /// it doesn't matter.
        /// </remarks>
        ...
        #endregion Otri primitives (internal)
    }
}