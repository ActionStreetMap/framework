// ----------------------------------------------------------------------- 
// <copyright file="Vertex.cs"> Triangle.NET code by Christian Woltering, http://triangle.codeplex.com/ </copyright>
// ----------------------------------------------------------------------- 
...
namespace ActionStreetMap.Core.Polygons.Topology.DCEL
{
    public class Vertex : Point
    {
        ...
        /// <summary> Gets or sets a half-edge leaving the vertex. </summary>
        ...
        /// <summary> Enumerates all half-edges leaving this vertex. </summary>
        /// <returns></returns>
