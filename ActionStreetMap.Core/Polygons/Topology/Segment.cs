...
namespace ActionStreetMap.Core.Polygons.Topology
{
    ...
    public class Segment : ISegment
    {
        ...
        // Set up 'dummysub', the omnipresent subsegment pointed to by any triangle side or
        // subsegment end that isn't attached to a real subsegment.
        ...
        static Segment()
        {
            ...
            // Initialize the two adjoining subsegments to be the omnipresent subsegment. These will
            // eventually be changed by various bonding operations, but their values don't really
            // matter, as long as they can legally be dereferenced.
            Empty.subsegs[0].seg = Empty;
            Empty.subsegs[1].seg = Empty;
        }

        #endregion Static initialization of "omnipresent" subsegment
