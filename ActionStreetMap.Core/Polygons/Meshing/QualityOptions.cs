...
namespace ActionStreetMap.Core.Polygons.Meshing
{
    ...
    public class QualityOptions
    {
        ...
        /// <remarks>
        /// The test function will be called for each triangle in the mesh. The second argument is
        /// the area of the triangle tested. If the function returns true, the triangle is
        /// considered bad and will be refined.
        /// </remarks>
        public Func<ITriangle, double, bool> UserTest { get; set; }

        /// <summary> Gets or sets an area constraint per triangle. </summary>
        /// <remarks>
        /// If this flag is set to true, the <see cref="ITriangle.Area"/> value will be used to
        /// check if a triangle needs refinement.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// If the value is 0 (default), an unknown number of Steiner points may be inserted to meet
        /// the other quality constraints.
        /// </remarks>
