...
namespace ActionStreetMap.Tests.Core.Tiling
{
    ...
    public class TileRegistryTests
    {
        ...
        public void CanRegisterLocalModel()
        {
            ...
            int testId = 7;
            int otherId = 5;
            var tile = new Tile(new GeoCoordinate(0, 0), new MapPoint(0, 0), null, CoreConsts.MaxZoomLevel, 100, 100);
        ...
        public void CanRegisterGlobalId()
        {
            ...
            int testId = 7;
            int otherId = 5;
            var tile1 = new Tile(new GeoCoordinate(0, 0), new MapPoint(0, 0), null, CoreConsts.MaxZoomLevel, 100, 100);
            var tile2 = new Tile(new GeoCoordinate(0, 0), new MapPoint(100, 100), null, CoreConsts.MaxZoomLevel, 100, 100);
