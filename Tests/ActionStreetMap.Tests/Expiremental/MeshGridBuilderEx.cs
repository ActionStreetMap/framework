    ...
    internal class MeshGridBuilderEx
    {
        ...
        private MeshGridCell CreateCell(Rectangle rectangle, CanvasData content)
        {
           ...
           // var resultRoads = CreateMeshRegions(polygon, ClipByRectangle(rectangle, content.Roads));
            ...
            SVGBuilder.SaveToFile(ClipByRectangle(rectangle, content.Roads), "roads.svg", 0.01);
            SVGBuilder.SaveToFile(ClipByRectangle(rectangle, content.Surfaces), "surfaces.svg", 0.01);
