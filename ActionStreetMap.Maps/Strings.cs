namespace ActionStreetMap.Maps
{
    ...
    {
        public static string SearchNotSupported = "Search doesn't support given IElementSource implementation";
        public static string NotSupportedMapFormat = "Unknown or not supported map format";
        public static string NoPresistentElementSourceFound = "No offline map data found for {0}, will query default server";
